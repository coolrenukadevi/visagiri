                            ...
                            <ul class="d-xl-block">
                                <li class="d-flex align-items-center">
                                    ...
                                    <div class="offcanvas__contact-text">
                                        <a target="_blank" href="#"><?php echo $site_city; ?>, India</a>
                                    </div>
                                </li>
                                <li class="d-flex align-items-center">
                                    ...
                                    <div class="offcanvas__contact-text">
                                        <a href="mailto:<?php echo $site_email; ?>"><span class="mailto:<?php echo $site_email; ?>"><?php echo $site_email; ?></span></a>
                                    </div>
                                </li>
                                <li class="d-flex align-items-center">
                                    <div class="offcanvas__contact-icon mr-15">
                                ...
                                <li class="d-flex align-items-center">
                                    ...
                                    <div class="offcanvas__contact-text">
                                        <a href="tel:<?php echo $site_phone_e164; ?>"><?php echo $site_phone_display; ?></a>
                                    </div>
                                </li>
                            </ul>
