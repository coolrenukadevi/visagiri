...
function sitemap_static_pages(): array
{
    return [
        ...
        ['forex', 'monthly', '0.8'],
        ['forex-foreign-currency', 'monthly', '0.7'],
        ['forex-card', 'monthly', '0.7'],
        ['forex-currency-exchange', 'monthly', '0.7'],
        ['forex-travel', 'monthly', '0.7'],
        ['forex-enquiry', 'monthly', '0.7'],
        ['travel-services', 'monthly', '0.8'],
        ['travel-insurance', 'monthly', '0.7'],
        ['flight-hotel', 'monthly', '0.7'],
        ['invitation-letter', 'monthly', '0.6'],
        ['airport-assist', 'monthly', '0.6'],
        ['corporate-travel', 'monthly', '0.7'],
        ['pricing', 'monthly', '0.7'],
        ['about', 'monthly', '0.7'],
        ['why-choose-us', 'monthly', '0.6'],
        ['vision-mission', 'monthly', '0.5'],
        ...
        ['visa-tourist', 'weekly', '0.85'],
        ['visa-business', 'weekly', '0.85'],
        ['visa-work', 'weekly', '0.85'],
        ['visa-family', 'weekly', '0.85'],
        ['visa-transit', 'monthly', '0.75'],
        ['visa-medical', 'monthly', '0.75'],
        ['visa-sports', 'monthly', '0.7'],
        ['visa-crew', 'monthly', '0.7'],
        ['visa-extension', 'monthly', '0.75'],
