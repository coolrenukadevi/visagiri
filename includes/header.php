...
// Indicative USD->INR rate for the header utility bar — see
// includes/currency-rate.php for the fetch/cache/fallback logic. This
// intentionally never throws and never blocks rendering; $usdInrRate['rate']
// is simply null if no rate (live or cached) is available at all.
$usdInrRate = get_usd_inr_rate();
$supportPhoneDial = setting('contact_phone_dial', '+917065819819');
        ...
        <div class="container site-header__utility-bar">
            ...
            <div class="site-header__utility-contact">
                <a href="<?= e(whatsapp_enquiry_href('Hello Visagiri, I would like assistance with my travel/visa-related enquiry.')) ?>" class="site-header__utility-link" target="_blank" rel="noopener noreferrer">
                    ...
                    <span class="site-header__utility-link-text">24&times;7 Support</span>
                </a>
