<?php
/*
 * Vendored third-party library — unmodified. FPDF (fpdf.org) by Olivier
 * Plathey, released under a permissive free license: usable, modifiable and
 * redistributable for any purpose including commercial use, with no
 * dependencies and no attribution requirement in generated output. Used here
 * so the Forex module's "Download PDF" quotation/receipt buttons produce
 * real PDF files without needing Composer or any external service — this
