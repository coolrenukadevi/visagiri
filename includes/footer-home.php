        <footer class="footer-section-2 fix footer-bg-2">
            <div class="shape">
                <img src="assets/img/home-2/Vector.png" alt="img">
            </div>
            <div class="container">
                <div class="footer-newsletter fade-up-anim">
                    <div class="newsletter-content">
                        <h3>Sing Up To Get Latest Updates</h3>
                        <p>Subscribe to our newsletter and stay informed with the latest visa news </p>
                    </div>
                    <form action="#">
                         <div class="form-clt">
                        <img src="assets/img/home-2/icon/02.svg" alt="img" class="input-icon">
