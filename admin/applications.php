...
foreach ($applications as $a) { $counts[$a['decision'] ?: 'Pending']++; }
?>
...
<div class="crm-card" style="padding:0;">
    ...
    <div class="crm-empty">No enquiries have entered application processing yet.</div>
    <?php else: ?>
    <div class="crm-table-wrap">
    <table class="crm-table">
        <thead><tr><th>Enquiry</th><th>Customer</th><th>Country</th><th>Application #</th><th>Appointment</th><th>Submitted</th><th>Decision Date</th><th>Status</th><th>Decision</th></tr></thead>
        <tbody>
        <?php foreach ($applications as $a): $decision = $a['decision'] ?: 'Pending'; ?>
        <tr>
