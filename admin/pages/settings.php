...
$fields = [
    ...
    'turnstile_site_key' => 'Cloudflare Turnstile site key (public — anti-spam challenge on Contact/Enquire/Partner forms; leave both Turnstile fields blank to disable)',
    'turnstile_secret_key' => 'Cloudflare Turnstile secret key (private — never shown on the site)',
    ...
    'enquiry_sla_hours_urgent' => 'Enquiry SLA — Urgent priority (hours)',
    'enquiry_sla_hours_high' => 'Enquiry SLA — High priority (hours)',
    'enquiry_sla_hours_normal' => 'Enquiry SLA — Normal priority (hours)',
    'enquiry_sla_hours_low' => 'Enquiry SLA — Low priority (hours)',
