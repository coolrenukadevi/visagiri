...
UPDATE visa_checklists SET meta_title = 'Japan Work Visa from India: COE Process & Requirements | Visagiri', meta_description = 'Japan work visa from India: how your employer''s Certificate of Eligibility (COE) leads to your VFS Global application, plus the document checklist.' WHERE reference = 'JPN-WORK-IN-04';
...
UPDATE visa_checklists SET meta_title = 'South Korea Work Visa (E-7) from India: Requirements & Process | Visagiri', meta_description = 'South Korea E-7 work visa from India: your employer''s CVI approval, visa stamping, and the 87 designated E-7 occupations, with the document checklist.' WHERE reference = 'KOR-WORK-IN-04';
...
UPDATE visa_checklists SET meta_title = 'Thailand Work Visa from India: WP.3, Non-B & Work Permit | Visagiri', meta_description = 'Thailand work visa from India: the WP.3 pre-approval, Non-Immigrant "B" visa, and post-arrival Work Permit steps, with the document checklist.' WHERE reference = 'THA-WORK-IN-04';
