        ...
        <section class="section-padding fix">
            <div class="container">
                ...
                <div class="svc-why-grid" style="margin-top:32px;">
                    ...
                    <div class="svc-why-item"><div class="check">04</div><div><h4>Extension guidance included</h4><p>If treatment runs longer than expected, we advise on the extension process &mdash; see our <a href="visa-extension">Visa Extension</a> page.</p></div></div>
                </div>
                <div class="faq-accordion" style="margin-top:32px;">
                    ...
                    <div class="faq-item">
                        ...
                        <div class="faq-answer"><p>Many countries allow medical visa extensions with updated hospital documentation. See our <a href="visa-extension">Visa Extension</a> page, or ask your case handler once you're abroad.</p></div>
                    </div>
                    <div class="faq-item">
                ...
                <div class="text-center mt-5">
                    <a href="contact" class="theme-btn" data-open-enquiry>Start Your Medical Visa Enquiry <i class="fa-solid fa-arrow-right"></i></a>
                </div>
            </div>
        </section>
