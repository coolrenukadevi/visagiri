...
$errors = [];
$customer = $token !== '' ? verify_customer_password_reset_token($token) : null;
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (mb_strlen($password) < 8) {
        ...
        reset_customer_password((int) $customer['id'], $password);
...
<section class="section" style="padding-top:var(--space-8)">
    <div class="container" style="max-width:420px">
        ...
        <?php endforeach; ?>
        <form method="post" action="/reset-password/" class="card" style="padding:var(--space-6)">
            <?= csrf_field() ?>
