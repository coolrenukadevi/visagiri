...
$page_description = "Transit visa consultancy for connecting flights and layovers &ndash; route checks, documentation and fast-turnaround filing.";
        ...
        <section class="section-padding fix">
            <div class="container">
                ...
                <div class="text-center mt-5">
                    <a href="contact" class="theme-btn" data-open-enquiry>Start Your Transit Visa Enquiry <i class="fa-solid fa-arrow-right"></i></a>
                </div>
            </div>
        </section>
