...
$page_description = "Visa extension assistance for stays already granted &ndash; eligibility, timing and reason-specific documentation to avoid overstay complications.";
        ...
        <section class="section-padding fix">
            <div class="container">
                ...
                <div class="text-center mt-5">
                    <a href="contact" class="theme-btn" data-open-enquiry>Start Your Extension Enquiry <i class="fa-solid fa-arrow-right"></i></a>
                </div>
            </div>
        </section>
