...
?>
        ...
        <nav class="svc-sibling-nav" aria-label="Forex services">
            <div class="svc-sibling-inner">
                <a href="forex#currency" class="current">Foreign Currency</a>
                <a href="forex#forex-card">Forex Card</a>
                <a href="forex#currency-exchange">Currency Exchange</a>
                <a href="forex#travel-forex">Travel Forex</a>
        ...
        <section class="section-padding fix">
            <div class="container">
                ...
                <div class="svc-why-grid">
                    <div class="svc-why-item" id="currency"><div class="check">01</div><div><h4>Foreign Currency</h4><p>Buy foreign currency notes in the currency and amount you need for your trip, at a rate confirmed before you commit.</p></div></div>
                    <div class="svc-why-item" id="forex-card"><div class="check">02</div><div><h4>Forex Card</h4><p>A prepaid travel card loaded in your destination currency &mdash; a safer alternative to carrying large amounts of cash.</p></div></div>
                    <div class="svc-why-item" id="currency-exchange"><div class="check">03</div><div><h4>Currency Exchange</h4><p>Exchange currency for your specific travel or business need, guided through the documentation FEMA purpose codes require.</p></div></div>
                    <div class="svc-why-item" id="travel-forex"><div class="check">04</div><div><h4>Travel Forex</h4><p>General travel forex guidance &mdash; unsure which option fits your trip? We help you work out currency, amount and format.</p></div></div>
                </div>
            </div>
        </section>
